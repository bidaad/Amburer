...
namespace Amburer.UserControls
{
    public partial class UCSupport : System.Web.UI.UserControl
    {
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //long[] rec = null;
                //byte[] status = null;
                //Amburer.com.panelesms.www.Send SmsPanel = new Amburer.com.panelesms.www.Send();
            ...
            catch (Exception errSMS)
            {
                ...
                bool SendErrResult = tools.SendEmail(errMailBody, " خطا در  دسیلی ", "admin@Amburer.ir", "bidaad@gmail.com", "", "");
            }
