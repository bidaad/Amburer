<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSelectedPics.ascx.cs"
    Inherits="Amburer.UserControls.UCSelectedNews" %>
<div class="layerslider-wrapper box hidden-xs">
    <div class="bannercontainer banner-boxed" style="padding: 0px; margin: 0px 0px 0px;">
        <div id="sliderlayer" class="rev_slider boxedbanner" style="width: 630px; height: 413px;">
            <ul>
                <li data-link="http://www.Amburer.ir" data-masterspeed="300" data-transition="random"
