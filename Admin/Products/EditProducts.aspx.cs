...
public partial class Products_EditProducts : EditForm<Products>
{
        ...
        try
        {
            ...
            if (ReturnCode != -1)
            {
                ...
                if (uplLargePicFile.UploadedFiles.Count > 0 || string.IsNullOrEmpty( CurProduct.SmallPicFile))
                {
                    ...
                    SavePic(CurProduct.LargePicFile, RandSmallPic, HttpContext.Current.Request.MapPath("~/Files/Products/Small/"), 320);
    ...
    {
        string Tab1Click = "BrowseObj1.ShowDetail('ProductPictures', '" + Code + "', true,'BrowseObj1');";
